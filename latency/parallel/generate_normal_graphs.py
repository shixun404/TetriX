...
if __name__ == "__main__":
    N = 500
    print(f"Generating N={N} graphs with normal distribution weights (μ=100, σ=50)...")
    ...
    print(f"\nGeneration complete!")
    print(f"Test graphs: 5 files saved as G_{N}_normal_test_*.pkl")
    print(f"Background graph: G_{N}_NORMAL.pkl") 