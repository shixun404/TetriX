    ...
    for itr in range(max_iterations):
        ...
        for lengths in all_paths_lengths:
            ...
            for node in range(N):
                ...
                # print('neighbor_lengths.shape', neighbor_lengths.shape, neighbor_lengths)
                # print('succesor', len(successor[node]), successor[node])
        ...
        remaining_neighbors = []
        # print('start select neighbour')
        for i in range(N):
            # print(len(successor[i]), i)
            try:
